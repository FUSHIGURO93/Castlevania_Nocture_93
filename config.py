...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002350663610"))
# NAMA OWNER
...
try:
    ADMINS=[6727550037]
    for x in (os.environ.get("ADMINS", "6727550037 1683225887 5961139833").split()):
        ADMINS.append(int(x))
except ValueError:
        raise Exception("Your Admins list does not contain valid integers.")

#Force sub message 
FORCE_MSG = os.environ.get("FORCE_SUB_MESSAGE", "<b>Hᴇʟʟo!! {mention}✨,\n\n𝐃ᴜᴇ ᴛᴏ 𝐎ᴠᴇʀʟᴏᴀᴅ, 𝐎ɴʟʏ 𝐂ʜᴀɴɴᴇʟ 𝐒ᴜʙsᴄʀɪʙᴇʀs ᴄᴀɴ ᴜsᴇ ᴛʜᴇ 𝐁ᴏᴛ !! 𝐏ʟᴇᴀsᴇ ᴊᴏɪɴ ᴏᴜʀ ᴄʜᴀɴɴᴇʟs ᴀɴᴅ ᴄʟɪᴄᴋ ᴏɴ •Tʀʏ Aɢᴀɪɴ• ʙᴜᴛᴛᴏɴ ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ʀᴇǫᴜᴇꜱᴛᴇᴅ ᴍᴏᴠɪᴇ ꜰɪʟᴇ.\n\n𝐌ᴀɪɴ 𝐂ʜᴀɴɴᴇʟ : <a href='https://t.me/Movies_Castlevani'>𝐌ᴏᴠɪᴇs 𝐂ᴀsᴛʟᴇᴠᴀɴɪᴀ</a></b>")
